...
CREATE TABLE nfl.league_conference (id int IDENTITY(1,1), conference_name nvarchar(100))
...
CREATE TABLE nfl.team (
    ...
    team_hq_statecode nvarchar(100) NULL,
...
INSERT INTO nfl.office_employees (team_id, person_id, office_role_id, start_date) VALUES (
